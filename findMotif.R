...
rawMatx <- as.matrix(rawData1[,3:length(rawData1)])  #conversed into matrix
chemType <- rawData1[,2]        #extract the chemical categories
rownames(rawMatx)<- rawData1$odorantName[1:110]    #names of odors
...
#first find the "bi-fan" motif, this is just one of the defined motif
...
## here after, we plot the histogram of all the compared motifs in the original and 
## randomized matrix
